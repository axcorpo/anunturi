...
use backend\modules\website\models\PageForm;
...
class PageController extends MainController
{
	...
	{
		$model = $this->findModel($id, PageForm::class);
		$result = true;
	 ...
	 * @return \yii\db\ActiveQuery|\yii\db\ActiveRecord|Page|PageForm
	 * @throws NotFoundHttpException if no model was found
	 */
	protected function findModel($id, $modelName = null, $asActiveQuery = false)
	{
		$modelName = class_exists($modelName) ? $modelName : Page::class;
		...
		$query->andWhere(['deleted' => Page::NO]);
