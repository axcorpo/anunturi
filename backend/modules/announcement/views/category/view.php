...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Category')]);
...
$this->params['actions'] = [
    ...
    [
        'visible' => Yii::$app->user->can('updateCategory'),
        'tag' => 'a',
    ...
    'attributes' => [
        [
            ...
            'value' => function (Category $model) {
                if ($model->imageUrl && is_file(Yii::getAlias("@uploads/category/{$model->id}/{$model->image}"))) {
        ...
        [
            ...
            'value' => function (Category $model) {
                return $model->parent->treeName ?: '&mdash;';
            },
        ],
        [
            'format' => 'html',
                ...
                'clientOptions' => [
                    ...
                    'ajax' => [
                        ...
                        'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(Category::class) . '; 
