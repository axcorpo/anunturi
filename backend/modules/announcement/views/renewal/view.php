...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Renewal')]);
...
$this->params['actions'] = [
    ...
    [
        'visible' => Yii::$app->user->can('updateRenewal'),
        'tag' => 'a',
                ...
                <div class="portlet box blue-hoki mt-15">
                    ...
                    <div class="portlet-body">
                        <?= DataTable::widget([
							...
							data.model = ' . json_encode(Renewal::class) . '; 
