...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Tutorial')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateTutorial'),
		'tag' => 'a',
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(Tutorial::class) . '; 
