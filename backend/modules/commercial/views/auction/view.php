...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Auction')]);
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(Auction::class) . '; 
