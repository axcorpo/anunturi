...
use backend\modules\commercial\models\BidForm;
use backend\modules\commercial\models\BidSearch;
...
class BidController extends MainController
{
	...
	{
		if (Yii::$app->request->get('deleted') == Bid::YES) {
			if (!Yii::$app->settings->get('enableSoftDelete') || !Yii::$app->user->can('deleteBid')) {
	...
	/**
	 * Restores Bid models that are marked as deleted.
	...
	/**
	 * Finds the Bid model(s) based on its primary key value.
	 * A 404 HTTP exception will be thrown if no record was found.
	 *
	 * @param int|array $id
	 * @param \yii\db\ActiveRecord|null $modelName
	 * @param bool $asActiveQuery
	 * @return \yii\db\ActiveQuery|\yii\db\ActiveRecord|Bid|BidForm
	 * @throws NotFoundHttpException if no model was found
	 */
