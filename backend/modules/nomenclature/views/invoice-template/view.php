...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Invoice Template')]);
$this->params['breadcrumbs'] = [
	...
	[
		'label' => Yii::t('common', 'Invoice Templates'),
		'url' => ['index'],
	],
	Yii::t('common', 'View'),
];
$this->params['actions'] = [
	[
		'visible' => Yii::$app->user->can('viewInvoiceTemplate'),
		'tag' => 'a',
		'url' => ['index'],
		'icon' => 'fa fa-list',
		'options' => [
	...
	[
		'visible' => Yii::$app->user->can('updateInvoiceTemplate'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteInvoiceTemplate') && !$model->default,
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('createInvoiceTemplate'),
		'tag' => 'a',
		'url' => ['create'],
		'icon' => 'fa fa-plus',
		'options' => [
