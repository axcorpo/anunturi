...
use common\models\UnitOfMeasureCode;
			...
			<div class="row">
				<div class="col-sm-4">
					<?= $form->field($model, 'status')->widget(Select2::class, [
						'data' => ArrayHelper::getColumn(UnitOfMeasure::getStatusLabels(), 'label'),
						'pluginLoading' => false,
						'pluginOptions' => [
							'allowClear' => false,
				...
				<div class="col-sm-4">
					<?= $form->field($model, 'code_id')->widget(Select2::class, [
						'data' => ArrayHelper::getColumn(UnitOfMeasureCode::findAllOfMeasureCodes(), 'translation.name'),
						'pluginLoading' => false,
						'pluginOptions' => [
							'placeholder' => Yii::t('common', 'Choose'),
						],
