...
use backend\modules\marketing\models\FollowupSmsCampaignForm;
use backend\modules\marketing\models\FollowupSmsCampaignSearch;
...
class FollowupSmsCampaignController extends MainController
{
	/**
	 * @inheritdoc
	 */
		...
		return [
			'access' => [
				...
				'rules' => [
					[
						'allow' => true,
						'actions' => ['index', 'view', 'dt-followup-sms-campaigns'],
	...
	{
		return [
			'dt-followup-sms-campaigns' => FollowupSmsCampaignSearch::class,
		];
	}
	...
	{
		$model = new FollowupSmsCampaignForm();
	...
	{
		$model = $this->findModel($id, FollowupSmsCampaignForm::class);
		$searchModel = new MarketingRecipientSearchForm();
	 ...
	 * @return \yii\db\ActiveQuery|\yii\db\ActiveRecord|FollowupMarketingCampaign|FollowupSmsCampaignForm
	 * @throws NotFoundHttpException if no model was found
	 */
	protected function findModel($id, $modelName = null, $asActiveQuery = false)
	{
		...
		$query = $modelName::find()->andWhere([
			...
			'variant' => FollowupMarketingCampaign::VARIANT_SMS,
		]);
