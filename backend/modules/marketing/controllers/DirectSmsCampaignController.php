...
use backend\modules\marketing\models\DirectSmsCampaignForm;
use backend\modules\marketing\models\DirectSmsCampaignSearch;
...
class DirectSmsCampaignController extends MainController
{
	/**
	 * @inheritdoc
	 */
	...
	{
		return [
			'dt-direct-email-campaigns' => DirectSmsCampaignSearch::class,
		];
	}
	...
	{
		$model = new DirectSmsCampaignForm();
	...
	{
		$model = $this->findModel($id, DirectSmsCampaignForm::class);
		$searchModel = new MarketingRecipientSearchForm();
	 ...
	 * @return \yii\db\ActiveQuery|\yii\db\ActiveRecord|DirectMarketingCampaign|DirectSmsCampaignForm
	 * @throws NotFoundHttpException if no model was found
	 */
	protected function findModel($id, $modelName = null, $asActiveQuery = false)
	{
		...
		$query = $modelName::find()->andWhere([
			...
			'variant' => DirectMarketingCampaign::VARIANT_SMS,
		]);
