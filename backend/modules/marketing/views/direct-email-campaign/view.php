...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Email Campaign')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateDirectMarketingCampaign'),
		'tag' => 'a',
	...
	<?= DetailView::widget([
		...
		'attributes' => [
			[
				...
				'value' => function (DirectMarketingCampaign $model) {
			...
			[
				...
				'value' => function (DirectMarketingCampaign $model) {
					return Html::tag('div', $model->translation->content ?: '&mdash;', ['class' => 'small-preview-container']);
				},
			],
			[
				'format' => 'html',
				'label' => Yii::t('label', 'Recipients'),
				'value' => function (DirectMarketingCampaign $model) {
					return count($model->marketingCampaignHasRecipients);
				},
			],
			[
				'format' => 'html',
				'label' => Yii::t('label', 'Frequency'),
				'value' => function (DirectMarketingCampaign $model) {
					return $model->frequency ? $model->getFormattedFrequency() : '&mdash;';
				},
			],
			[
				'format' => 'html',
				'label' => Yii::t('label', 'Progress'),
				'value' => function (DirectMarketingCampaign $model) {
					return $model->getFormattedProgress(false);
				},
			],
			[
				'format' => 'html',
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . Json::encode(MarketingCampaign::class) . '; 
