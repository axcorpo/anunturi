...
namespace frontend\modules\firm;
...
class Module extends \yii\base\Module implements \yii\base\BootstrapInterface
{
	...
	protected function buildUrlRules()
	{
		...
		foreach ($pages as $page) {
			...
			if ($page->controller == 'default') {
				$urlRules = array_merge($urlRules, $this->buildCompanyUrlRules($page));
				continue;
			}
	...
	/**
	 * Builds the Company URL Rules.
	 *
	 * @param \common\models\Page $page
	 * @return array
	 */
	protected function buildCompanyUrlRules($page)
	{
		$route = "{$page->controller}/{$page->action}";
		// View route
		$urlRules[] = [
