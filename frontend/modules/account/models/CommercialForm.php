...
class CommercialForm extends Commercial
{
	...
	protected function saveFiles()
	{
		...
		try {
			...
			$oldFilePath = Yii::getAlias("@uploads/commercial/{$this->id}/{$this->oldAttributes['image']}");
			$fileName = UploadHelper::saveImage($file, $this->id, "@uploads/commercial/{$this->id}", $width, $height, true);
