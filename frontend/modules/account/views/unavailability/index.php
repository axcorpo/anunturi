            ...
            <div class="col-lg-12 col-xs-12 dashboardBoxBg">
                <?= DataTable::widget([
                    ...
                    'clientOptions' => [
                        ...
                        'serverSide' => true,
                        'ajax' => [
                            'url' => Url::to(['dt-unavailabilities']),
                            'method' => 'POST',
                        ...
                        'pageLength' => (int) Yii::$app->settings->get('itemsPerUnavailability'),
                        'lengthMenu' => [
                            'autoCreate' => true,
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'filter' => ['select', ArrayHelper::getColumn(Unavailability::getStatusLabels(), 'label')],
                            ],
                        ],
                    ],
                ]) ?>
