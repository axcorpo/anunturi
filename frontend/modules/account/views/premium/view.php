...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Promotional')]);
...
$this->params['actions'] = [
    ...
    [
        'visible' => Yii::$app->user->can('updatePromotional'),
        'tag' => 'a',
                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        [
                            ...
                            'value' => function (Promotional $model) {
                ...
                <div class="portlet box blue-hoki mt-15">
                    ...
                    <div class="portlet-body">
                        <?= DataTable::widget([
							...
							data.model = ' . json_encode(Promotional::class) . '; 
