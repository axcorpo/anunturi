                            ...
                            'value' => function (Review $model) {
                                if ($announcements = $model->getAnnouncement()->active(true)->deleted(false)->all()) {
                                    return implode('', array_map(function (Announcement $announcement) {
                                        return Html::a($announcement->translation->title, ['/announcement-manager/announcement/view', 'id' => $announcement->id], ['class' => 'btn btn-xs btn-default btn-primary']);
                                    }, $announcements));
                                }
                                return '&mdash;';
                            },
...
//                        ],
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-light btn-slide-center-v btn-primary" data-dismiss="modal"><?= Yii::t('common', 'Close') ?></button>
        </div>
    </div>
</div>
<?php endif; ?>
