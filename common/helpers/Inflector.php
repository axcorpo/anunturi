...
{
    public static function slug($string, $replacement = '-', $lowercase = true, $language = null, $urlencode = false)
    {
        ...
        switch ($language) {
            case 'ar-AE':
                ...
                $string = $urlencode ? urlencode($string) : $string;
                break;
            default:
                ...
                $char_map = array(
                    ...
                    'Ă' => 'A', 'ă' => 'a', 'Â' => 'A', 'â' => 'a', 'Î' => 'I', 'î' => 'i', 'Ș' => 'S', 'ş' => 's',
